...
export default function Details (){
    ...
    const handleSubmit = (event) =>{
        ...
        // optimizeData() -->
        setResult([{"partnerName":"max", "leadId":"1234","proposalNo":"0001","issuanceDate":"12-05-2020","docType":"BI","docname":"sdsad","options":""},
                        ...
                        <div className="row">
                            ...
                            <div>
                                <div>
                                    ...
                                    <Collapse in={open}>
                                    <div id="collapse" style={{width: '100%',textAlign: 'justify'}}>
                                        <div>
                                            <div className="row" style={{ padding: "10px 0px 10px 0px", width: "100%", margin: "0px", border: "1px solid grey", borderRadius: "8px", backgroundColor: "#EBEBEB" }}>
                                                <div className="col-6">
                                                    <div className="row">
        ...
        { showTable ? <Table data={result} /> : null }
    </>
    )
